...
@section('content')
    <div class="col-ls-5 col-sm-8">

        <div class="card">

            <div class="card-body"> 
                    <h1 class="text-center  text-success text-uppercase fw-bolder mb-4">Register</h1>
                ...
                <form action="{{ route('register') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row g-3  mt-3">
                        ...
                        <option value="{{ $role['id'] }}" @selected($role['id']==old('role') ? "selected" : '')>{{ $role['name'] }}</option>
                    @endforeach
                        </select>
